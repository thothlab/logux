...
- **Двухстрочная раскладка логов** -- шапка с колонками timestamp / level / pid / tid / tag, затем message отдельной строкой с отступом на всю ширину экрана (длинные сообщения автоматически переносятся); между записями пустая строка-разделитель
